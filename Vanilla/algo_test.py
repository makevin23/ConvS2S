...
Encoder = conv_encoder.ConvEncoder(len(index_to_word), max_input_length + 2, 128, 512, 16, 1)
Decoder = conv_decoder.ConvDecoder(len(index_to_word), max_target_length + 2, 128, 512, 16, 1)
